...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "inventory.filterStock": { sw: "Hali ya hifadhi", en: "Stock status" },
  "inventory.filterAll": { sw: "Bidhaa zote", en: "All products" },
  "inventory.filterLow": { sw: "Hifadhi ndogo", en: "Low stock" },
  "inventory.filterOut": { sw: "Zimekwisha", en: "Out of stock" },
  "inventory.filterIncoming": { sw: "Zinakuja", en: "Incoming" },
  "inventory.filterSupplier": { sw: "Msambazaji", en: "Supplier" },
  "inventory.filterAllSuppliers": { sw: "Wasambazaji wote", en: "All suppliers" },
  "inventory.filterNoSupplier": { sw: "Bila msambazaji", en: "No supplier" },
  "inventory.filterReorder": { sw: "Hali ya kuagiza tena", en: "Reorder status" },
  "inventory.filterAllReorder": { sw: "Hali zote", en: "All reorder statuses" },
  "inventory.filterReorderable": { sw: "Agiza tena", en: "Reorderable" },
  "inventory.filterStopped": { sw: "Usiagize tena", en: "Do not reorder" },
  "inventory.clearFilters": { sw: "Futa vichujio", en: "Clear filters" },
  "inventory.showing": { sw: "Inaonyesha {shown} kati ya {total}", en: "Showing {shown} of {total}" },
  "inventory.noMatchingProducts": { sw: "Hakuna bidhaa zinazolingana", en: "No matching products" },
  "inventory.clearFiltersHint": { sw: "Badilisha au futa vichujio kuonyesha bidhaa zaidi", en: "Change or clear the filters to show more products" },
  ...
  "inventory.retailProfit": { sw: "Faida ya rejareja", en: "Retail profit" },
  "inventory.wholesaleProfit": { sw: "Faida ya jumla", en: "Wholesale profit" },
